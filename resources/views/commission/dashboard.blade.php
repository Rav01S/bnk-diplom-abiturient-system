@extends('layouts.app')
@section('title', 'Дашборд | Комиссия')
@section('header', 'Панель сотрудника')
@section('sidebar') @include('partials.sidebar-commission') @endsection
@section('content')
<div class="mb-6"><h2 class="text-xl font-semibold text-gray-900">Рабочий стол</h2><p class="text-gray-500 text-sm">Приёмная кампания 2024</p></div>
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
  <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4"><div class="flex items-center justify-between mb-2"><span class="text-sm font-medium text-gray-600">На проверке</span><span class="text-blue-600 bg-blue-50 p-2 rounded-lg"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></span></div><p class="text-2xl font-bold">{{ $pendingCount }}</p><p class="text-xs text-gray-500">Ожидают решения</p></div>
